...
public class Order_stub implements Orderblservice{
	...
	OrderVO vo1=new OrderVO(OrderType.ABNORMAL,new Date(),new Date(),new Date(),new Date(),new Date(),new Date(),"aaaaa","11111","lalala",RoomType.BIG,2,2,true);
	OrderVO vo2=new OrderVO(OrderType.ABNORMAL,new Date(),new Date(),new Date(),new Date(),new Date(),new Date(),"aaaaa","11111","lalala",RoomType.BIG,2,2,true);
