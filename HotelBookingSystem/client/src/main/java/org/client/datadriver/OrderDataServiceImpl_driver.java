...
public class OrderDataServiceImpl_driver {
	...
	public static void main(String[] args) {
		...
		try {
			stub.init();
			System.out.println(stub.add(new OrderPO(null, null, null, null, null, null, null, null, null, null, null, 0, 0, false)));
			...
			System.out.println(stub.modify(new OrderPO(null, null, null, null, null, null, null, null, null, null, null, 0, 0, false)));
			stub.finish();
