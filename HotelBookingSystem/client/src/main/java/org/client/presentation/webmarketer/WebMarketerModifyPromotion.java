...
public class WebMarketerModifyPromotion {
	...
	@FXML
    void initialize() {
        assert creditPane != null : "fx:id=\"creditPane\" was not injected: check your FXML file '修改促销策略界面.fxml'.";
        assert levelPane != null : "fx:id=\"levelPane\" was not injected: check your FXML file '修改促销策略界面.fxml'.";
        assert orderPane != null : "fx:id=\"orderPane\" was not injected: check your FXML file '修改促销策略界面.fxml'.";
        assert mainPane != null : "fx:id=\"mainPane\" was not injected: check your FXML file '修改促销策略界面.fxml'.";
	}
