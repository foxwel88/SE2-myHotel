...
public class HotelManagerCancelledOrder {
	...
	@FXML
    void initialize() {
        assert mainLabel != null : "fx:id=\"mainLabel\" was not injected: check your FXML file '已撤销订单详细信息界面.fxml'.";
        assert infoLabel != null : "fx:id=\"infoLabel\" was not injected: check your FXML file '已撤销订单详细信息界面.fxml'.";
        assert executeLabel != null : "fx:id=\"executeLabel\" was not injected: check your FXML file '已撤销订单详细信息界面.fxml'.";
        assert promotionLabel != null : "fx:id=\"promotionLabel\" was not injected: check your FXML file '已撤销订单详细信息界面.fxml'.";
