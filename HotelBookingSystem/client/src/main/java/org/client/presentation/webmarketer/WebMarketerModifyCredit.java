...
public class WebMarketerModifyCredit {
	...
	@FXML
    void initialize() {
        assert mainPane != null : "fx:id=\"mainPane\" was not injected: check your FXML file '信用充值界面.fxml'.";
        assert levelPane != null : "fx:id=\"levelPane\" was not injected: check your FXML file '信用充值界面.fxml'.";
        assert orderPane != null : "fx:id=\"orderPane\" was not injected: check your FXML file '信用充值界面.fxml'.";
        assert promotionPane != null : "fx:id=\"promotionPane\" was not injected: check your FXML file '信用充值界面.fxml'.";
	}
