...
public class Orderblservice_driver {
	...
	public static void main(String[] args){
		...
		System.out.println(stub.createOrder(new OrderVO(OrderType.ABNORMAL, new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), "wefw", "657", "as",RoomType.BIG, 1, 2, true, null)));
