...
public class Userblservice_driver {
	...
	public static void main(String[] args) {
		...
		System.out.println(stub.add
				(new UserVO(UserType.CUSTOMER.getString(), "123",
						"123", "123", "312", "ce",
						1.1, new Date(), "2142ew", 5, 6.6, "sad")));
		...
		System.out.println(stub.modify(new UserVO(UserType.CUSTOMER.getString(),
				"123", "123", "123",
				"312", "ce", 1.1, new Date(),
				"2142ew", 5, 6.6, "sad")));
		System.out.println(stub.addCreditRecord 
				(new CreditRecordVO(new Date(), "sdf", 1.8, 9.9,
